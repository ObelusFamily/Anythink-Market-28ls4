...
class Item extends React.Component {
    ...
    render() {
        ...
        const canModify = this.props.currentUser && this.props.currentUser.username === this.props.item.seller.username;
        return (
                    ...
                    <div className="row bg-white p-4">
                        ...
                        <div className="col-6">
                            ...
                            this.props.item.tagList.map((tag) => {
                                return (
                                    <span className="badge badge-secondary p-2 mx-1"
                                        key={tag}>
                                        {tag} </span>
                                );
                            })
